...
export default function ResetPasswordClient() {
  ...
  return (
    <motion.div
      ...
      className="rounded-3xl border border-slate-700/70 bg-slate-950/90 p-4 sm:p-6 shadow-[0_18px_50px_rgba(15,23,42,0.9)] backdrop-blur-xl"
    >
        ...
        {!initialToken && (
          <div className="space-y-1.5">
            ...
            <input
              ...
              type="text"
              required
              className="w-full rounded-2xl border border-slate-700/70 bg-slate-950/70 px-3 py-2 text-sm text-slate-100 placeholder:text-slate-500 outline-none ring-0 focus:border-cyan-400/80 focus:ring-2 focus:ring-cyan-500/40"
              value={token}
