    ...
    <div className="min-h-screen bg-gradient-to-b from-white via-white to-blue-50 flex items-center justify-center px-4">
      <div className="w-full max-w-xl">
        ...
        <div className="mb-6 flex items-center gap-3">
          <div className="h-9 w-9 rounded-2xl bg-blue-100 flex items-center justify-center border border-blue-200 shadow-sm">
        ...
        {/* Card wrapper */}
        <div className="bg-white/90 border border-slate-200 rounded-2xl shadow-xl shadow-blue-100/80 p-5 sm:p-7">
          {children}
        </div>
